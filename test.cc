...
const string pre_words_str = "grunt verify carbon lion olive blame claim mobile comic deliver";
const vector<unsigned char> decoded_target_address = DecodeBase58("TUtYYPC9y1ebmU2kdRRgVnEkNE5UHkeVav");
